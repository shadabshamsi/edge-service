...
import com.shadabshamsi.edgeservice.user.User;
...
public class UserControllerTests {
    ...
    void whenAuthenticatedThenReturnUser() {
        ...
        webClient.mutateWith(configureMockOidcLogin(expectedUser)).get().uri("/user").exchange().expectStatus()
                .is2xxSuccessful().expectBody(User.class).value(user -> assertThat(user).isEqualTo(expectedUser));
    }
